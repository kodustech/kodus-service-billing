...
KEYS=(
    ...
    "/qa/kodus-service-billing/STRIPE_PRICE_ID_TEAMS_BYOK_ANNUAL"
    "/qa/kodus-service-billing/STRIPE_PRICE_ID_TEAMS_MANAGED"
    "/qa/kodus-service-billing/STRIPE_PRICE_ID_TEAMS_MANAGED_ANNUAL"
    "/qa/kodus-service-billing/STRIPE_PRICE_ID_TEAMS_MANAGED_LEGACY"
    "/qa/kodus-service-billing/STRIPE_PRICE_ID_ENTERPRISE_BYOK"
    "/qa/kodus-service-billing/STRIPE_PRICE_ID_ENTERPRISE_BYOK_ANNUAL"
    "/qa/kodus-service-billing/STRIPE_PRICE_ID_ENTERPRISE_MANAGED"
    "/qa/kodus-service-billing/STRIPE_PRICE_ID_ENTERPRISE_MANAGED_ANNUAL"
