...
KEYS=(
    ...
    "/prod/kodus-service-billing/STRIPE_PRICE_ID_TEAMS_BYOK"
    "/prod/kodus-service-billing/STRIPE_PRICE_ID_TEAMS_BYOK_ANNUAL"
    "/prod/kodus-service-billing/STRIPE_PRICE_ID_TEAMS_MANAGED"
    "/prod/kodus-service-billing/STRIPE_PRICE_ID_TEAMS_MANAGED_ANNUAL"
    "/prod/kodus-service-billing/STRIPE_PRICE_ID_TEAMS_MANAGED_LEGACY"
    "/prod/kodus-service-billing/STRIPE_PRICE_ID_ENTERPRISE_BYOK"
    "/prod/kodus-service-billing/STRIPE_PRICE_ID_ENTERPRISE_BYOK_ANNUAL"
    "/prod/kodus-service-billing/STRIPE_PRICE_ID_ENTERPRISE_MANAGED"
    "/prod/kodus-service-billing/STRIPE_PRICE_ID_ENTERPRISE_MANAGED_ANNUAL"
    ...
    "/prod/kodus-service-billing/KODUS_NOTIFICATION_WEBHOOK_SECRET"
)
